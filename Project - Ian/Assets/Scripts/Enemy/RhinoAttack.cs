...
public class RhinoAttack : MonoBehaviour {
    ...
    [HideInInspector]
    public SlimeDebuff SlimeDebuff;     //Reference to a slime debuff that may prevent attacking

    [SerializeField]
    float timeBetweenAttacks = 0.5f;        //How much time goes by between each attack (the attack interval)
    [SerializeField]
    int attackDamage = 10;                  //How much damage the enemy attacks for
    [SerializeField]
